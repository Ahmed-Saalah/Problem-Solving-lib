...
const int base1 = uniform_int_distribution<long long>(30,  50)(rng), mod1 = 1000000007;
const int base2 = uniform_int_distribution<long long>(51,  70)(rng), mod2 = 1000000009;
...
void PreCalc() // calong long it before along long the test cases
{
...
// zero index. l , r and the length of the string
...
void solve()
{
    ...
    for(int i = 0 ; i < n ; i++)
    {
        if(!is_pal(0 , i , n) && !is_pal(i + 1 , n - 1 , n))
        {
            cout << "YES\n";
            cout << 2 << '\n';
